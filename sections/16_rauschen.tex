...
$$ e_{\rm on} = r_{\rm in} \sqrt{ \int\limits_{0}^{\infty} \frac{1}{1 + 2 \pi f R C} \, \diff f }
...
\begin{minipage}[c]{0.58\columnwidth}
    \begin{outline}
        \1 6 Rauschquellen 
            \2 $e_1$, $e_2$, $e_3$ sind Rauschspannungen der Widerstände    % CHECK Rauschspannungen oder Spannungsdichten
