...
\fbox{\parbox{0.8\columnwidth}{
    \begin{tabular}{@{}ll@{}}
        Rauschleistungsdichte   & $e_{\rm out}^2 = S_{\rm out} = 4 k T \frac{R_1 \cdot R_2}{R_1 + R_2}$ \\
        Rauschleistung          & $E_{\rm out} = 4 k T \frac{R_1 \cdot R_2}{R_1 + R_2} B$ \\   
        Rauschspannungsdichte   & $e_{\rm out} = \sqrt{S_{\rm out} } = \sqrt{ 4 k T \frac{R_1 \cdot R_2}{R_1 + R_2}}$ \\
        Rauschspannung          & $v_{\rm out} = \sqrt{ 4 k T \frac{R_1 \cdot R_2}{R_1 + R_2} B}$ \\
    \end{tabular}
}}
...
\begin{minipage}[c]{0.58\columnwidth}
    ...
    \fbox{\parbox{0.95\columnwidth}{
        ...
        \begin{tabular}{@{}ll@{}}
            Rauschspannungsdichte   & $e_{R_1} = \sqrt{4 k T R_1 \Big(- \frac{R_2}{R_1} \Big)^2} $ \\
...
\begin{minipage}[c]{0.58\columnwidth}
    ...
    \fbox{\parbox{0.96\columnwidth}{
        ...
        \begin{tabular}{@{}ll@{}}
            Rauschspannungsdichte   & $e_{R_3} = \sqrt{4 k T R_3 \Big( \frac{R_1 + R_2}{R_1} \Big)^2} $ \\
...
\begin{minipage}[c]{0.58\columnwidth}
    ...
    \fbox{\parbox{0.92\columnwidth}{
        ...
        \begin{tabular}{@{}ll@{}}
            Rauschspannungsdichte   & $e_{\rm opv} = \sqrt{e_n \Big( \frac{R_1 + R_2}{R_1}} \Big)^2 $ \\
...
$$ \boxed{ \scriptstyle{  V_{\rm noise} = \sqrt{ \int\limits_{0}^{\infty} \,  \Biggl[
    4 k T R_2 \Bigl( \frac{R_1 + R_2}{R_1} \Bigr) + 4 k T R_3 \Bigl( \frac{R_1 + R_2}{R_1} \Bigr)^2
