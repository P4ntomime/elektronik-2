...
\fbox{\parbox{0.68\columnwidth}{
    \begin{tabular}{ll}
        Rauschleistungsdichte   & $e_n^2 = S = 4 k T R$ \\
        Rauschleistung          & $E = 4 k T R B$ \\
        Rauschspannungsdichte   & $e_n = \sqrt{S} = \sqrt{e_n^2} = \sqrt{4 k T R}$ \\
        Rauschspannung          & $v_n =  \sqrt{4 k T R B}$
    \end{tabular}
}}
...
\fbox{\parbox{0.8\columnwidth}{
    \begin{tabular}{@{}ll@{}}
        Rauschleistungsdichte   & $e_{\rm out}^2 = S_{\rm out} = 4 k T \frac{R_1 \cdot R_2}{R_1 + R_1}$ \\
        Rauschleistung          & $E_{\rm out} = 4 k T \frac{R_1 \cdot R_2}{R_1 + R_1} B$ \\   
        Rauschspannungsdichte   & $e_{\rm out} = \sqrt{S_{\rm out} } = \sqrt{ 4 k T \frac{R_1 \cdot R_2}{R_1 + R_1}}$ \\
        Rauschspannung          & $v_{\rm out} = \sqrt{ 4 k T \frac{R_1 \cdot R_2}{R_1 + R_1} B}$ \\
    \end{tabular}
}}
...
\begin{minipage}[c]{0.58\columnwidth}
    ...
    \fbox{\parbox{0.95\columnwidth}{
        % reduce spacing between cols
        \newlength{\otcs}
        \setlength{\otcs}{\tabcolsep}
        \setlength{\tabcolsep}{1mm}

        \begin{tabular}{@{}ll@{}}
            Rauschspannungsdichte   & $e_{R_1} = \sqrt{4 k T R_1 \Big(- \frac{R_2}{R_1} \Big)} $ \\ % mathematisch illegal aber die slides sagen es so...
            Rauschleistungsdichte   & $e_{R_1}^2 = 4 k T R_1 \Big(- \frac{R_2}{R_1} \Big)^2 $ \\
        \end{tabular}
    }}
\end{minipage}
...
\begin{minipage}[c]{0.58\columnwidth}
    ...
    \fbox{\parbox{0.85\columnwidth}{
        \begin{tabular}{@{}ll@{}}
            Rauschspannungsdichte   & $e_{R_2} = \sqrt{4 k T R_2} $ \\
            Rauschleistungsdichte   & $e_{R_2}^2 = 4 k T R_2 $ \\
        \end{tabular}
    }}
\end{minipage}
...
\begin{minipage}[c]{0.58\columnwidth}
    ...
    \fbox{\parbox{0.96\columnwidth}{
        \begin{tabular}{@{}ll@{}}
            Rauschspannungsdichte   & $e_{R_3} = \sqrt{4 k T R_3 \frac{R_1 + R_2}{R_1}} $ \\
            Rauschleistungsdichte   & $e_{R_3}^2 = 4 k T R_3 \Big( \frac{R_1 + R_2}{R_1} \Big)^2 $ \\
        \end{tabular}
    }}
\end{minipage}
...
\begin{minipage}[c]{0.58\columnwidth}
    ...
    \fbox{\parbox{0.92\columnwidth}{
        \begin{tabular}{@{}ll@{}}
            Rauschspannungsdichte   & $e_{\rm opv} = \sqrt{e_n \frac{R_1 + R_2}{R_1}} $ \\
            Rauschleistungsdichte   & $e_{\rm opv}^2 = e_n \Big( \frac{R_1 + R_2}{R_1} \Big)^2 $ \\
        \end{tabular}

        \setlength{\tabcolsep}{\otcs}   % set cols spacing back to default
    }}
\end{minipage}
