...
\subsubsection{Kennlinien}
    ...
    \begin{minipage}[t]{0.43\columnwidth}
        ...
        \includegraphics[align=c, width=\columnwidth]{images/jfet_eingangskennlinie.png}    % Pinch-Off Spannung V_p in Bild ergänzen
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.54\columnwidth}
        \textbf{Ausgangskennlinien} \\
        \includegraphics[align=c, width=\columnwidth]{images/jfet_ausgangskennlinien.png}   % linearen Bereich und Sättigungs-Bereich kennzeichnen
    \end{minipage}
...
\subsubsection{Sättigungs-Bereich (Stromquelle)}
    ...
    \begin{minipage}[t]{0.68\columnwidth}
        \begin{itemize}
            ...
            \textrightarrow $V_{DSP} = V_{GS} - V_p$ ($V_p =$ Pinch-Off-Spannung)   % klären, ob das so stimmt
        \end{itemize}

        $$ I_D = \frac{ I_{DSS}}{V_p^2} \cdot ( V_{GS} - V_p )^2 $$
    \end{minipage}

    % Folgendes entspricht nicht den Guidelines:
...
\subsubsection{Kleinsignal-Ersatzschaltung}
    ...
    \begin{minipage}[t]{0.33\columnwidth}
        ...
        $$ KP = C_{oc} \cdot \mu_n \approx 100 \frac{\mathrm{\mu} \ampere}{\volt^2} $$  % kann man noch verbessern...
    \end{minipage}
