...
\usepackage{booktabs}               % better positioned lines in tables
\usepackage{boldline}               % bold (vertical) lines in tables


\usepackage{amsmath}                % math symbols
\usepackage{amssymb}                % more math symbols
\usepackage{txfonts}                % additional math fonts
...
\usepackage{circuitikz}             % needed for electric circuits
